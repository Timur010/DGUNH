...
//    func sendRequest<T: Decodable> (endpoint: Endpoint, responseModel: T.Type, media: [Media]? = nil, urlEncoded: Bool = false) async ->  Result<T, RequestError> {
...
//                    request.httpBody = createBodyWithParameters(parameters: endpoint.parameters, medias: media, boundary: boundary)
//                } else {
//                    if urlEncoded {
